...
cd $WIN64_DIR && tar -czf $WOS_BUILD_DIR/$WIN64_TARBALL . && cd $CWD
cd $LINUX64_DIR && tar -czf $WOS_BUILD_DIR/$LINUX64_TARBALL . && cd $CWD
cd $FBSD64_DIR && tar -czf $WOS_BUILD_DIR/$FBSD64_TARBALL . && cd $CWD
cd $DARWIN_DIR && tar -czf $WOS_BUILD_DIR/$DARWIN_TARBALL . && cd $CWD
cd $COMBINED_DIR && cp ../*/wiki.* $COMBINED_DIR/ && tar -czf $WOS_BUILD_DIR/$COMBINED_TARBALL . && cd $CWD
